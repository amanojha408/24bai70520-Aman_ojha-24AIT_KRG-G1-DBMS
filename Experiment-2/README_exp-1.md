...
Output Details
• Aggregate Results: The system successfully grouped employees by department. ![alt text](<ss1.png>)
• Filtering Logic: The WHERE clause correctly excluded employees with salaries under 20,000 (like Sara and Vikram) before calculating averages.![alt text](<ss2.png>)
...
• Sorting: The ORDER BY clause successfully sorted the final results from highest to lowest average salary. ![alt text](<ss3.png>) 6. Learning Outcome
